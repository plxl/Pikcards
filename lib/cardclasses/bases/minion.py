...
class Minion(Card):
    def __init__(
        ...
        """General inheritable class for a Minion type card
        ...
        Args:
            ...
            base_attack (int): Minion default attack points, used when reset
            base_health (int): Minion default health points, used when reset
            base_defense (int): Minion default defense points, used when reset
            max_carry (int): Maximum number of Items this Minion can carry
